...
import orangeSq from '../../assets/shape-images/orange-sq.png';
import peachSq from '../../assets/shape-images/peach-sq.png';
import blueOval from '../../assets/shape-images/blue-oval.png';
import eraserEllipse from '../../assets/shape-images/eraser-ellipse.png';
...
import orangeCircle from '../../assets/shape-images/orange-circle.png';
import blueCircle from '../../assets/shape-images/blue-circle.png';
...
const Pebbles = ({ data }) => {
  ...
  useEffect(() => {
    function runMatter() {
      ...
      let bodies = [
        ...
        Bodies.circle(
          window.innerWidth / 2 + windowWidth * 0.3,
      ...
      const greenCircleBody = Bodies.circle(
        0,
        window.innerHeight / 2 + 200,
        150,
        {
      ...
      //Pink cirlce at end
      const pinkCircleBody = Bodies.circle(
        window.innerWidth,
        window.innerHeight / 2 + 200,
        150,
        {
      ...
      function handleResize() {
        ...
        Composite.scale(composite, widthDifference, heightDifference, {
          x: 0,
          y: 0,
        });
      }
  ...
  return <div style={wrapperStyle} ref={sceneEl} />;
};
